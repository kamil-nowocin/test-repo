...
if [[ "$GITHUB_EVENT_NAME" == "schedule" ]]; then
    ...
    case $CURRENT_TIME in
        ...
        190[0-9] | 191[0-9] | 192[0-5]) TEST_MODULE="Websters" TEST_ENVIRONMENT="UAT" ;;  # Trigger time between 19:00 - 18:25
        193[0-9] | 194[0-9] | 195[0-5]) TEST_MODULE="Klasters" TEST_ENVIRONMENT="UAT" ;;  # Trigger time between 19:30 - 18:55
