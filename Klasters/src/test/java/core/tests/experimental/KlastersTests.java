...
@Slf4j
public class KlastersTests extends Hooks {
  ...
  @Test(testName = "Test that should fail - Klasters", description = "Test that should fail - Klasters")
  public void testThatShouldFail() {
    printSecret();
    fail("Failed on purpose");
  }

  @Test(testName = "Test that should pass - Klasters", description = "Test that should pass - Klasters")
  ...
  public void moveAllureResultsContent12() {
    moveAllureResultsContent("Klasters");
  }
